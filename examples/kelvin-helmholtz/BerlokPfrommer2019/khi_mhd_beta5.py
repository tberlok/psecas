...
if True:
    ...
    write_athena(system, Nz=256, Lz=2.0, path="./athena-solutions/",
                 name="khi_mhd_beta5")

    save_system(system, "./athena-solutions/khi_mhd_beta5.p")
    ...
    plot_solution(system, filename='./athena-solutions/khi_mhd_beta5.pdf')
